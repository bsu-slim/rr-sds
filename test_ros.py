...
from retico.interop.ros.catkin_ws.src.rosretico.src.RosWriter import RosWriter
from retico.interop.ros.catkin_ws.src.rosretico.src.RosReader import RosReader

def initROSNodes(args):
    RosWriter(args)
